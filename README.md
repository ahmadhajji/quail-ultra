...
Use the Apple Silicon release zip attached to the GitHub release. The packaged app has a separate bundle ID and user-data path from original Quail, so both apps can live on the same Mac.

### Windows

Windows builds are published as alpha artifacts.
